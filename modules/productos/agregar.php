...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        try {
            // Agregar el producto
            $result = agregarProducto($nombre, $precio, $categoria_id);
            
            if ($result) {
                // Producto agregado con éxito, redirigir a la lista de productos
                $_SESSION['alerta'] = [
                    'tipo' => 'success',
                ...
                $errores[] = "No se pudo agregar el producto";
            }
        ...
        <form action="agregar.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="precio" name="precio" step="0.01" min="0.01" required value="<?php echo htmlspecialchars($_POST['precio'] ?? ''); ?>">
                </div>
            </div>
